 ...
 * 
 */
@WebServiceClient(name = "WorkflowService", targetNamespace = "http://www.example.org/Workflow", wsdlLocation = "file:/D:/dp2/Assignment4/wsdl/Workflow.wsdl")
    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns WorkflowOperations
     */
    @WebEndpoint(name = "WorkflowOperationsPort")
    public WorkflowOperations getWorkflowOperationsPort() {
        return super.getPort(new QName("http://www.example.org/Workflow", "WorkflowOperationsPort"), WorkflowOperations.class);
    }
     ...
     */
    @WebEndpoint(name = "WorkflowOperationsPort")
    public WorkflowOperations getWorkflowOperationsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/Workflow", "WorkflowOperationsPort"), WorkflowOperations.class, features);
    }
